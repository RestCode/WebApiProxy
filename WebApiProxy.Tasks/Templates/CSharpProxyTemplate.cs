            ...
            this.Write(@".Clients
{
	...
	public abstract partial class ClientBase : IDisposable
	{
		...
		protected ClientBase(HttpMessageHandler handler, bool disposeHandler = true)
		{
            ...
            #line 207 "E:\git\github\WebApiProxy\WebApiProxy.Tasks\Templates\CSharpProxyTemplate.tt"
 foreach(var definition in Configuration.Metadata.Definitions) { 
            ...
            #line 211 "E:\git\github\WebApiProxy\WebApiProxy.Tasks\Templates\CSharpProxyTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(definition.Name));
 ...
 if(!String.IsNullOrEmpty(method.ReturnType) && method.ReturnType != "void" ) { 
            ...
            #line 357 "E:\git\github\WebApiProxy\WebApiProxy.Tasks\Templates\CSharpProxyTemplate.tt"
